...
early_stopping = keras.callbacks.EarlyStopping(monitor='val_loss', patience=5, min_delta=0.1, verbose=1, restore_best_weights=True)
...
model.save("optimized_model2.keras")